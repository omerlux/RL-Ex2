...
for i_episode in range(max_episodes):
    ...
    for t in count():
        ...
        if params.target_update == 'soft':
            ...
            with torch.no_grad():
                for (param_target, param_policy) in zip(target_net.parameters(), policy_net.parameters()):
                    param_target.data = params.tau * param_policy.data + (1 - params.tau) * param_target.data
            ...
            # target_net.load_state_dict(sd_target)
