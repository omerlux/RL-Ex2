...
training_params = {
    ...
    'epsilon_end': 0.0162,              # 0.05,
    'epsilon_decay': 0.7565,            # 0.95,
    'target_update': 'hard',            # use 'soft' or 'hard'
    'tau': 0.0,                         # 0.01,  # relevant for soft update
    'target_update_period': 30,         # relevant for hard update
    'grad_clip': 0.168,                 # 0.1
}
logging.info(network_params)
