...
# ============================================================================
# episode 39 best {'hidden_dim': 126, 'batch_size': 341, 'gamma': 0.8624399406197127, 'epsilon_end': 0.014529815852924807,
# 'epsilon_decay': 0.6900051051033075, 'tau': 0.11084220692035414, 'grad_clip': 0.2199215296865687}.
# Parameters
network_params = {
...
training_params = {
    ...
    'epsilon_end': 0.0184,              # 0.05,
    'epsilon_decay': 0.537,             # 0.95,
    'target_update': 'soft',            # use 'soft' or 'hard'
    'tau': 0.486,                       # 0.01,  # relevant for soft update
    'target_update_period': 0,          # relevant for hard update
    'grad_clip': 0.168,                 # 0.1
}
logging.info("network_params: {}".format(network_params))
logging.info("training_params: {}".format(training_params))
